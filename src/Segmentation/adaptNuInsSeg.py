...
def main():
    ...
    for folder in tqdm(folders):
        ...
        for i in range(n_train):
            aux = train_iter+i
            save(img_path, i, TRAIN_PATH, "Image", aux*4, "png", IMG_HEIGHT, IMG_WIDTH)
            save(mask_path, i, TRAIN_PATH, "Mask", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
            save(mask_alter_path, i, TRAIN_PATH, "Mask alter", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
        train_iter += n_train
        
        for i in range(n_val):
            aux = val_iter+i
            save(img_path, i, VAL_PATH, "Image", aux*4, "png", IMG_HEIGHT, IMG_WIDTH)
            save(mask_path, i, VAL_PATH, "Mask", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
            save(mask_alter_path, i, VAL_PATH, "Mask alter", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
        val_iter += n_val

        for i in range(n_test):
            aux = test_iter+i
            save(img_path, i, TEST_PATH, "Image", aux*4, "png", IMG_HEIGHT, IMG_WIDTH)
            save(mask_path, i, TEST_PATH, "Mask", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
            save(mask_alter_path, i, TEST_PATH, "Mask alter", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
        test_iter += n_test
    ...
    for folder in tqdm(folders):
        ...
        for i in range(n_total):
            aux = alter_iter+i
            save(img_path, i, ALTER_PATH, "Image", aux*4, "png", IMG_HEIGHT, IMG_WIDTH)
            save(mask_path, i, ALTER_PATH, "Mask", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
            save(mask_alter_path, i, ALTER_PATH, "Mask alter", aux*4, "bmp", IMG_HEIGHT, IMG_WIDTH)
        alter_iter += n_total
