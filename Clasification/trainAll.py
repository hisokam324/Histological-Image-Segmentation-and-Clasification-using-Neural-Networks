...
use_saved_model_global = configuration["train"]["use saved"]
...
if device == torch.device("cuda"):
    ...
    batch_size = gpu_ram//(IMG_HEIGHT*IMG_WIDTH*3)
else:
...
for selected_model in model_options:
    ...
    use_saved_model = use_saved_model_global and os.path.exists(os.path.join(MODEL_PATH, f"{selected_model}.pth"))
