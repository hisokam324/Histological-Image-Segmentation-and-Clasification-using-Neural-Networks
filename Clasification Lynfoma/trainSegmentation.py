...
model_options = configuration["models"]["segmentation"]["all"]
...
DATA_PATH = os.path.join(BASE_DIR,configuration["path"]["dataset segmentation"])
...
model_name = configuration["models"]["segmentation"][selected_model]["model"]
criterion_configuration = configuration["models"]["segmentation"][selected_model]["criterion"]
optimizer_configuration = configuration["models"]["segmentation"][selected_model]["optimizer"]
...
train_loader = utils.create_loader(utils.load_images(os.path.join(DATA_PATH, data_division[0]), isClasification = False, verbose = verbose), batch_size = batch_size, isClasification = False)
validation_loader = utils.create_loader(utils.load_images(os.path.join(DATA_PATH, data_division[1]), isClasification = False, verbose = verbose), batch_size = batch_size, isClasification = False)
test_loader = utils.create_loader(utils.load_images(os.path.join(DATA_PATH, data_division[2]), isClasification = False, verbose = verbose), batch_size = batch_size, isClasification = False)
