...
train_loader = utils.create_loader(utils.load_images(os.path.join(DATA_PATH, data_division[0]), isClasification = True, verbose = verbose), batch_size = batch_size, isClasification = True)
validation_loader = utils.create_loader(utils.load_images(os.path.join(DATA_PATH, data_division[1]), isClasification = True, verbose = verbose), batch_size = batch_size, isClasification = True)
